...
// ==================================================================
// 3. HTML MOBILE (SÓ NOME E ZAP + ACESSO LIVRE)
// ==================================================================
...
// ROTA ADICIONAR LOJA (REDIRECIONA PARA /marketing)
...
// ROTA SALVAR EDIÇÃO (CORRIGIDA COM PARSEINT E REDIRECIONAMENTO)
app.post('/salvar-marketing', (req, res) => {
    const { id, arquivo, cor, qtd, prefixo } = req.body;
    let idNum = parseInt(id); // <--- O PULO DO GATO 1
    
    let lojaAlvo = campanhas.find(c => c.id === idNum); // <--- O PULO DO GATO 2
    ...
    if(lojaAlvo) {
        ...
        // REDIRECIONA AUTOMATICAMENTE PARA NÃO DAR ERRO DE ROTA
        res.redirect('/marketing'); // <--- O PULO DO GATO 3
    } else {
